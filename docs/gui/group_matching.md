...
The layout mirrors stage 1: a vertical-only left column for file controls, FOV filter, response settings, and finish actions; a right workspace with ROI cards and response previews.
