...
from twopy.analysis.timing import RecordingTiming, resolve_recording_timing
    ...
    *,
    ...
    Args:
        ...
        epoch_windows: Optional explicit epoch windows. When omitted, twopy
            resolves native timing from converted stimulus and photodiode data.
    ...
    timing, resolved_epoch_windows = _resolve_epoch_windows(recording, epoch_windows)
...
def _resolve_epoch_windows(
...
) -> tuple[RecordingTiming | None, tuple[EpochFrameWindow, ...]]:
    ...
    return timing, timing.epoch_windows
