...
- The napari ROIs tab has an explicit ROI mode selector. Manual Labels drawing is the default, grid mode can create labels from pixel sizes or calibrated micron sizes, and watershed mode can create labels from the converted mean image.
